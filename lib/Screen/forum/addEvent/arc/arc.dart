...
import 'package:proddeccec/Screen/forum/addEvent/arc/login.dart';
import 'package:proddeccec/backend/size_config.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:url_launcher/url_launcher.dart';

class Event7 extends StatefulWidget {
  @override
  _Event7State createState() => _Event7State();
}

class _Event7State extends State<Event7> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: StreamBuilder(
          stream: FirebaseFirestore.instance.collection('eArc').snapshots(),
          builder:
